<template>
  <div class="flex flex-row h-screen overflow-hidden p-8">
    ...
    <div class="w-3/4 ml-12 container flex-col">
      <div class="flex items-center justify-between pb-4 px-8">
        <input
          type="text"
          @input="e => setExpression(e.target.value)"
          :value="expression"
      ...
      <div
        class="bg-white shadow-xl relative w-full overflow-y-auto h-screen max-h-3/4 rounded-xl my-6"
      >
