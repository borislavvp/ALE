<template>
  <div class="flex flex-row h-screen overflow-hidden">
    <div class="mr-6 mt-6">
      <div
        class="h-60 w-80 rounded-xl border border-gray-300 mx-6 justify-content-center flex flex-col items-center py-3 px-2"
      >
        <div
          @click="SeeOverview"
          :class="[
    ...
    <div class="m-auto container flex-col my-6 mr-6 ">
      <div class="flex pb-4">
        <input
          type="text"
          @input="e => setExpression(e.target.value)"
          :value="expression"
          class="w-full h-10 focus:outline-none focus:ring focus:border-green-700 rounded-md shadow-lg px-2"
        />
        <button
